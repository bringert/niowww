 ...
 * serving threads.
 *
 * NioWebserver is a small and fast web server that tries to be 
 * standards-compliant whenever that is easy.
 */
public class NioWebServer implements Runnable {
	 ...
	 */
	private static final String SERVER_NAME = "NIO web server";
