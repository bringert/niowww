 ...
 * encoding and decoding ISO-8859-1 data, and encoding
 * dates using the RFC 1123 date format.
 *
 * This class is not thread safe. Each thread must use
...
public class HttpCodings {
	...
	/** 
	 * RFC 1123 date format string representation.
	 */
	private static final String RFC_1123_DATE_FORMAT = 
	"E, dd MMM yyyy HH:mm:ss z";

	/** 
	 * RFC 1123 timezone (GMT) name.
	 */
	 ...
	 *
	 * @return A CharBuffer that is shared between invocations, so
	 * don't keep using it after calling the method again.
	 */
